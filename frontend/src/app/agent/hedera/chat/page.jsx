...
import {useHederaCodeAgentContract} from "@/hooks/useHederaAgentContract";
      ...
      <div className="min-h-screen">
          ...
          <div className="flex gap-5 w-full px-5 justify-between items-center mt-5">
              <div className="flex flex-col  justify-center ">
                  ...
                  <p className="">Our agent knows just about everything there is to know about Hedera!</p>
              </div>

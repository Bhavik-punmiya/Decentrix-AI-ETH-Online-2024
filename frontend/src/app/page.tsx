            ...
            <div className="bg-theme-off-white-light rounded-xl p-10 w-full mt-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-7">
                    ...
                    <div className="bg-theme-gray-light rounded-xl shadow-lg p-5">
                        ...
                        <div className="font-light text-lg mt-3">
                            Blockless is the infrastructure platform to launch, integrate, and secure Network Neutral
                            Applications (nnApps).
                        </div>
                    </div>
                    ...
                    <div className="bg-theme-gray-light rounded-xl shadow-lg p-5">
                        ...
                        <div className="font-light text-lg mt-3">
                            Morph is a blockchain platform focused on seamless asset exchanges and decentralized finance
                            solutions.
                        </div>
                    </div>
                    ...
                    <div className="bg-theme-purple-light rounded-xl shadow-lg p-5">
                        ...
                        <div className="font-light text-lg mt-3">
                            Nethermind is a blockchain development company that provides Ethereum infrastructure and
                            tools.
                        </div>
                    </div>

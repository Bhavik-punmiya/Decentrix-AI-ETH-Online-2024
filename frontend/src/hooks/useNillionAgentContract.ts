...
type UseNillionCodeAgentContract = {
    code: string;
...
export function useNillionCodeAgentContract(): UseNillionCodeAgentContract {
    ...
    const handleRunAgent = useCallback(async (prompt: string) => {
        ...
        const codeGenerationQuery = `
            You are an AI assistant specializing in Nillion blockchain technology. Your task is to provide accurate, concise, and helpful responses to user queries about Nillion, using the knowledge base provided to you. Please follow these guidelines:
            ...
            Remember to use the knowledge base provided and avoid using any external information, your goal is to assist users in understanding and working with Nillion technology effectively. Tailor your response to best address the user's specific needs and level of expertise.
            `;

...
type UseGaladrielCodeAgentContract = {
    code: string;
...
export function useGaladrielCodeAgentContract(): UseGaladrielCodeAgentContract {
    ...
    const contractAddress = "0x299F1D7D936849431Fb5352780f0BDb4AeCDACab" ?? '';
    ...
    const handleRunAgent = useCallback(async (prompt: string) => {
        ...
        const codeGenerationQuery = `
            You are an AI assistant specializing in Galadriel blockchain technology. Your task is to provide accurate, concise, and helpful responses to user queries about Galadriel, using the knowledge base provided to you. Please follow these guidelines:
            ...
            Remember to use the knowledge base provided and avoid using any external information, your goal is to assist users in understanding and working with Galadriel technology effectively. Tailor your response to best address the user's specific needs and level of expertise.
            `;

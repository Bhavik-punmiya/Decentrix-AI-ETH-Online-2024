...
type UseFhenixCodeAgentContract = {
    code: string;
...
export function useFhenixCodeAgentContract(): UseFhenixCodeAgentContract {
    ...
    const contractAddress = "0x40f71345Fc84F232f21f5Aaa7211D43D636476eB";
    ...
    const handleRunAgent = useCallback(async (prompt: string) => {
        ...
        const codeGenerationQuery = `
            You are an AI assistant specializing in Fhenix blockchain technology. Your task is to provide accurate, concise, and helpful responses to user queries about Fhenix, using the knowledge base provided to you. Please follow these guidelines:
            ...
            Remember to use the knowledge base provided and avoid using any external information, your goal is to assist users in understanding and working with Fhenix technology effectively. Tailor your response to best address the user's specific needs and level of expertise.
            `;

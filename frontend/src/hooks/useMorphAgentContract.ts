...
type UseMorphCodeAgentContract = {
    code: string;
...
export function useMorphCodeAgentContract(): UseMorphCodeAgentContract {
    ...
    const contractAddress = "0x51e9fd97b68B73cCf0f1cD3a4B0Be5345038Be17";
    ...
    const handleRunAgent = useCallback(async (prompt: string) => {
        ...
        const codeGenerationQuery = `
            You are an AI assistant specializing in Morph blockchain technology. Your task is to provide accurate, concise, and helpful responses to user queries about Morph, using the knowledge base provided to you. Please follow these guidelines:
            ...
            Remember to use the knowledge base provided and avoid using any external information, your goal is to assist users in understanding and working with Morph technology effectively. Tailor your response to best address the user's specific needs and level of expertise.
            `;

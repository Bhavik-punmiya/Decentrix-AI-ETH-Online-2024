...
contract ChainlinkAgent {
    ...
    constructor(address initialOracleAddress, string memory systemPrompt, string memory knowledgeBaseCID) {
        ...
        config = IOracle.OpenAiRequest({
            ...
            temperature: 10,
            topP: 101,
            tools: '[{"type":"function","function":{"name":"web_search","description":"Search the internet for information relevant to Chainlink blockchain","parameters":{"type":"object","properties":{"query":{"type":"string","description":"Search query"}},"required":["query"]}}},{"type":"function","function":{"name":"code_interpreter","description":"Return all the relevant answers to users prompt","parameters":{"type":"object","properties":{"code":{"type":"string","description":"Solidity code to compile and return the compilation results"}},"required":["code"]}}}]',
            toolChoice: 'auto',
            user: ''
        });
    }
